...
public class DataBaseConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(PropertyUtil.TUTOR_MGT.getProperty(PROPERTY_NAME_DATABASE_DRIVER));
        dataSource.setUrl(PropertyUtil.TUTOR_MGT.getProperty(PROPERTY_NAME_DATABASE_URL));
        dataSource.setUsername(PropertyUtil.TUTOR_MGT.getProperty(PROPERTY_NAME_DATABASE_USERNAME));
        dataSource.setPassword(PropertyUtil.TUTOR_MGT.getProperty(PROPERTY_NAME_DATABASE_PASSWORD));
