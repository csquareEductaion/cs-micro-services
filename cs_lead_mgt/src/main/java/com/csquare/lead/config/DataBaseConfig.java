...
public class DataBaseConfig {
    ...
    private Properties hibProperties() {
        ...
        properties.put("hibernate.dialect", LEAD_MGT.getString(DataBase.HIBERNATE_DIALECT));
        properties.put("hibernate.show_sql", LEAD_MGT.getString(DataBase.HIBERNATE_SHOW_SQL));
