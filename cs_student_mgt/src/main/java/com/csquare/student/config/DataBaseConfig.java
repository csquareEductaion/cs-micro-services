...
public class DataBaseConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(PropertyUtil.STUDENT_MGT.getProperty(PROPERTY_NAME_DATABASE_DRIVER));
        dataSource.setUrl(PropertyUtil.STUDENT_MGT.getProperty(PROPERTY_NAME_DATABASE_URL));
        dataSource.setUsername(PropertyUtil.STUDENT_MGT.getProperty(PROPERTY_NAME_DATABASE_USERNAME));
        dataSource.setPassword(PropertyUtil.STUDENT_MGT.getProperty(PROPERTY_NAME_DATABASE_PASSWORD));
