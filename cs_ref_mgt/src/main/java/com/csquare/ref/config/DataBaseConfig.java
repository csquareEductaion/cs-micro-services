...
public class DataBaseConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(PropertyUtil.REF_MGT.getProperty(PROPERTY_NAME_DATABASE_DRIVER));
        dataSource.setUrl(PropertyUtil.REF_MGT.getProperty(PROPERTY_NAME_DATABASE_URL));
        dataSource.setUsername(PropertyUtil.REF_MGT.getProperty(PROPERTY_NAME_DATABASE_USERNAME));
        dataSource.setPassword(PropertyUtil.REF_MGT.getProperty(PROPERTY_NAME_DATABASE_PASSWORD));
